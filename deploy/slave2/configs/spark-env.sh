...
#export SPARK_MASTER_HOST=192.168.0.222
#export SPARK_MASTER_HOST=172.17.1.2
export SPARK_MASTER_IP=192.168.0.222
#export SPARK_MASTER_IP=172.17.1.2
...
#export SPARK_YARN_USER_ENV="CLASSPATH=/usr/local/hadoop/hadoop-2.8.5/etc/hadoop"
...
#export SPARK_LOCAL_IP=192.168.0.222
